...
constexpr double D1_OMEGA0_ALMANAC_LSB = TWO_N23;
constexpr double D1_E_ALMANAC_LSB = TWO_N21;
constexpr double D1_DELTA_I_LSB = TWO_N19;
constexpr double D1_TOA_LSB = TWO_P12;
constexpr double D1_OMEGA_DOT_ALMANAC_LSB = TWO_N38;
constexpr double D1_OMEGA_ALMANAC_LSB = TWO_N23;
constexpr double D1_M0_ALMANAC_LSB = TWO_N23;

...
public:
    ...
    double delta_n0dot{};  //!< Rate of mean motion difference from computed value at reference time [rad/sec^2]
    double ecc{};          //!< Eccentricity
    double sqrtA{};        //!< Square root of the semi-major axis [meters^1/2]
    double A0{};           //!< Semi-major axis [meters]
    double Adot{};         //!< Change rate of the semi-major axis [meters/s]

...
bool ControlThread::read_assistance_from_XML()
{
    ...
    std::string bds_dnav_almanac_xml_filename = configuration_->property("GNSS-SDR.SUPL_bds_dnav_almanac_xml", bds_dnav_almanac_default_xml_filename_);
    ...
    if (configuration_->property("GNSS-SDR.AGNSS_XML_enabled", false) == true)
        {
            ...
            gps_almanac_xml_filename = configuration_->property("GNSS-SDR.AGNSS_gps_almanac_xml", gps_almanac_default_xml_filename_);    bds_dnav_almanac_xml_filename = configuration_->property("GNSS-SDR.AGNSS_bds_dnav_almanac_xml", bds_dnav_almanac_default_xml_filename_);
        }
    ...
    if ((configuration_->property("Channels_B1.count", 0) > 0) || (configuration_->property("Channels_B3.count", 0) > 0))
        {
            ...
            if (supl_client_acquisition_.load_beidou_dnav_utc_xml(bds_dnav_utc_xml_filename) == true)
                {
            ...
            case 'd':
                {
                    ...
                    control_queue_->push(pmt::make_any(command_event_make(0, 5)));
                }
            break;
            case 's':
                {

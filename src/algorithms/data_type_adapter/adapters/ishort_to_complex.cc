                                ...
                                dump_(configuration->property(role + ".dump", false))
{
    ...
    scale_ = gr::blocks::multiply_const_cc::make(1.f / 32767.f);
    ...
    if (dump_)
        {
            if (inverted_spectrum)
                ...
                {
                    top_block->connect(gr_interleaved_short_to_complex_, 0, scale_, 0);
                    top_block->connect(scale_, 0, file_sink_, 0);
                }
        }
    else
    ...
    if (dump_)
        {
            if (inverted_spectrum)
                ...
                {
                    top_block->disconnect(gr_interleaved_short_to_complex_, 0, scale_, 0);
                    top_block->disconnect(scale_, 0, file_sink_, 0);
                }
        }
    else

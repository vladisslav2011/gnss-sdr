...
{
    constexpr uint32_t length_in = static_cast<uint32_t>(BEIDOU_B1C_CODE_LENGTH_CHIPS);
...
{
    constexpr int32_t code_freq_basis = static_cast<int32_t>(BEIDOU_B1C_CODE_RATE_CPS);

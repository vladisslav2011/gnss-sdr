    ...
    const std::string &role, double chip_rate, double opt_freq)
{
    ...
    coarse_doppler_max = configuration->property(role + ".coarse_doppler_max", coarse_doppler_max);
    doppler_max = configuration->property(role + ".doppler_max", doppler_max);
    fine_doppler_max = configuration->property(role + ".fine_doppler_max", fine_doppler_max);
    ...
    coarse_doppler_step = configuration->property(role + ".coarse_doppler_step", coarse_doppler_step);
    doppler_step = configuration->property(role + ".doppler_step", doppler_step);
    fine_doppler_step = configuration->property(role + ".fine_doppler_step", fine_doppler_step);
